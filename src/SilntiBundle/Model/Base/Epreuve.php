...
/**
 * Base class that represents a row from the 'epreuve' table.
 *
 *
 *
...
abstract class Epreuve implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SilntiBundle\\Model\\Map\\EpreuveTableMap';
    ...
    /**
     * The value for the id_epreuve field.
     *
     * @var        int
     */
    protected $id_epreuve;

    /**
     * The value for the dateepreuve field.
     *
     * @var        DateTime
     */
    ...
    /**
     * Initializes internal state of SilntiBundle\Model\Base\Epreuve object.
     */
    ...
    /**
     * Compares this with another <code>Epreuve</code> instance.  If
     * <code>obj</code> is an instance of <code>Epreuve</code>, delegates to
     * <code>equals(Epreuve)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Epreuve The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_epreuve] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [optionally formatted] temporal [dateepreuve] column value.
     *
     *
     ...
     */
    public function getDateepreuve($format = NULL)
    {
        if ($format === null) {
            return $this->dateepreuve;
        } else {
            return $this->dateepreuve instanceof \DateTimeInterface ? $this->dateepreuve->format($format) : null;
        }
    }
    ...
    /**
     * Set the value of [id_epreuve] column.
     *
     * @param int $v new value
     * @return $this|\SilntiBundle\Model\Epreuve The current object (for fluent API support)
     */
    public function setIdEpreuve($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_epreuve !== $v) {
            $this->id_epreuve = $v;
            $this->modifiedColumns[EpreuveTableMap::COL_ID_EPREUVE] = true;
        }
    ...
    /**
     * Sets the value of [dateepreuve] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\SilntiBundle\Model\Epreuve The current object (for fluent API support)
     */
    public function setDateepreuve($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->dateepreuve !== null || $dt !== null) {
            if ($this->dateepreuve === null || $dt === null || $dt->format("Y-m-d") !== $this->dateepreuve->format("Y-m-d")) {
                $this->dateepreuve = $dt === null ? null : clone $dt;
                $this->modifiedColumns[EpreuveTableMap::COL_DATEEPREUVE] = true;
            }
    ...
    public function setIntitule($v)
    {
        ...
        if ($this->intitule !== $v) {
            $this->intitule = $v;
            $this->modifiedColumns[EpreuveTableMap::COL_INTITULE] = true;
        }
    ...
    public function setIdCours($v)
    {
        ...
        if ($this->id_cours !== $v) {
            $this->id_cours = $v;
            $this->modifiedColumns[EpreuveTableMap::COL_ID_COURS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EpreuveTableMap::translateFieldName('IdEpreuve', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_epreuve = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EpreuveTableMap::translateFieldName('Dateepreuve', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->dateepreuve = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EpreuveTableMap::translateFieldName('Intitule', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intitule = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EpreuveTableMap::translateFieldName('IdCours', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = EpreuveTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SilntiBundle\\Model\\Epreuve'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEpreuveQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Epreuve::setDeleted()
     * @see Epreuve::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEpreuveQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EpreuveTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EpreuveTableMap::COL_ID_EPREUVE)) {
            $modifiedColumns[':p' . $index++]  = 'id_epreuve';
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_DATEEPREUVE)) {
            $modifiedColumns[':p' . $index++]  = 'dateEpreuve';
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_INTITULE)) {
            $modifiedColumns[':p' . $index++]  = 'intitule';
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_ID_COURS)) {
            $modifiedColumns[':p' . $index++]  = 'id_cours';
        }

        $sql = sprintf(
            'INSERT INTO epreuve (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_epreuve':
                        $stmt->bindValue($identifier, $this->id_epreuve, PDO::PARAM_INT);
                        break;
                    case 'dateEpreuve':
                        $stmt->bindValue($identifier, $this->dateepreuve ? $this->dateepreuve->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'intitule':
    ...
    {
        $pos = EpreuveTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdEpreuve();
                break;
            case 1:
                return $this->getDateepreuve();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Epreuve'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Epreuve'][$this->hashCode()] = true;
        $keys = EpreuveTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdEpreuve(),
            $keys[1] => $this->getDateepreuve(),
            $keys[2] => $this->getIntitule(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SilntiBundle\Model\Epreuve
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdEpreuve($value);
                break;
            case 1:
                $this->setDateepreuve($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdEpreuve($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDateepreuve($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setIntitule($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SilntiBundle\Model\Epreuve The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EpreuveTableMap::COL_ID_EPREUVE)) {
            $criteria->add(EpreuveTableMap::COL_ID_EPREUVE, $this->id_epreuve);
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_DATEEPREUVE)) {
            $criteria->add(EpreuveTableMap::COL_DATEEPREUVE, $this->dateepreuve);
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_INTITULE)) {
            $criteria->add(EpreuveTableMap::COL_INTITULE, $this->intitule);
        }
        if ($this->isColumnModified(EpreuveTableMap::COL_ID_COURS)) {
            $criteria->add(EpreuveTableMap::COL_ID_COURS, $this->id_cours);
        }
    ...
    {
        $criteria = ChildEpreuveQuery::create();
        $criteria->add(EpreuveTableMap::COL_ID_EPREUVE, $this->id_epreuve);
    ...
    {
        $validPk = null !== $this->getIdEpreuve();
    ...
    /**
     * Generic method to set the primary key (id_epreuve column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SilntiBundle\Model\Epreuve (or compatible) type.
    ...
    {
        $copyObj->setDateepreuve($this->getDateepreuve());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdEpreuve(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SilntiBundle\Model\Epreuve Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEpreuve is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEpreuve The current object (for fluent API support)
     */
     ...
     * Otherwise if this Epreuve is new, it will return
     * an empty collection; or if this Epreuve has previously
     * been saved, it will retrieve related Notes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Epreuve.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aCours) {
            $this->aCours->removeEpreuve($this);
        }
        $this->id_epreuve = null;
        $this->dateepreuve = null;
        $this->intitule = null;
        $this->id_cours = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
    ...
    {
        return (string) $this->exportTo(EpreuveTableMap::DEFAULT_STRING_FORMAT);
    }
