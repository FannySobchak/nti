...
abstract class Etudiant implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SilntiBundle\\Model\\Map\\EtudiantTableMap';
    ...
    /**
     * Initializes internal state of SilntiBundle\Model\Base\Etudiant object.
     */
     ...
     * @return $this|\SilntiBundle\Model\Etudiant The current object (for fluent API support)
     */
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[EtudiantTableMap::COL_ID_USER] = true;
        }
    ...
    public function setIdSession($v)
    {
        ...
        if ($this->id_session !== $v) {
            $this->id_session = $v;
            $this->modifiedColumns[EtudiantTableMap::COL_ID_SESSION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EtudiantTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EtudiantTableMap::translateFieldName('IdSession', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = EtudiantTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SilntiBundle\\Model\\Etudiant'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EtudiantTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_user';
        }
        if ($this->isColumnModified(EtudiantTableMap::COL_ID_SESSION)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SilntiBundle\Model\Etudiant
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SilntiBundle\Model\Etudiant The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EtudiantTableMap::COL_ID_USER)) {
            $criteria->add(EtudiantTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(EtudiantTableMap::COL_ID_SESSION)) {
            $criteria->add(EtudiantTableMap::COL_ID_SESSION, $this->id_session);
        }
    ...
    public function hashCode()
    {
        ...
        //relation FK_etudiant_id_user to table user
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SilntiBundle\Model\Etudiant (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SilntiBundle\Model\Etudiant Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSession(ConnectionInterface $con = null)
    {
        if ($this->aSession === null && ($this->id_session !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSession->addEtudiants($this);
             */
        }
    ...
    {
        if (null !== $this->aSession) {
            $this->aSession->removeEtudiant($this);
        }
        if (null !== $this->aUser) {
            $this->aUser->removeEtudiant($this);
        }
        $this->id_user = null;
