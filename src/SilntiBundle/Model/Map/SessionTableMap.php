...
use SilntiBundle\Model\Session;
use SilntiBundle\Model\SessionQuery;
...
class SessionTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\SilntiBundle\\Model\\Session';
     ...
     */
    const COL_ID_SESSION = 'session.id_session';

    /**
     * the column name for the libelle field
     */
    const COL_LIBELLE = 'session.libelle';

    /**
     * the column name for the date_inscription field
     */
    const COL_DATE_INSCRIPTION = 'session.date_inscription';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSession', 'Libelle', 'DateInscription', ),
        self::TYPE_CAMELNAME     => array('idSession', 'libelle', 'dateInscription', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID_SESSION, SessionTableMap::COL_LIBELLE, SessionTableMap::COL_DATE_INSCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id_session', 'libelle', 'date_inscription', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSession' => 0, 'Libelle' => 1, 'DateInscription' => 2, ),
        self::TYPE_CAMELNAME     => array('idSession' => 0, 'libelle' => 1, 'dateInscription' => 2, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID_SESSION => 0, SessionTableMap::COL_LIBELLE => 1, SessionTableMap::COL_DATE_INSCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('id_session' => 0, 'libelle' => 1, 'date_inscription' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('Etudiant', '\\SilntiBundle\\Model\\Etudiant', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_session',
    1 => ':id_session',
  ),
), null, null, 'Etudiants', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionTableMap::COL_LIBELLE);
            $criteria->addSelectColumn(SessionTableMap::COL_DATE_INSCRIPTION);
        } else {
            $criteria->addSelectColumn($alias . '.id_session');
            $criteria->addSelectColumn($alias . '.libelle');
            $criteria->addSelectColumn($alias . '.date_inscription');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SilntiBundle\Model\Session) { // it's a model object
