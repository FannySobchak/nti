...
class UserTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\SilntiBundle\\Model\\User';
    ...
    /**
     * the column name for the droit field
     */
    const COL_DROIT = 'user.droit';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUser', 'Nom', 'Prenom', 'Email', 'Mdp', 'Tel', 'Droit', 'Photo', ),
        self::TYPE_CAMELNAME     => array('idUser', 'nom', 'prenom', 'email', 'mdp', 'tel', 'droit', 'photo', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID_USER, UserTableMap::COL_NOM, UserTableMap::COL_PRENOM, UserTableMap::COL_EMAIL, UserTableMap::COL_MDP, UserTableMap::COL_TEL, UserTableMap::COL_DROIT, UserTableMap::COL_PHOTO, ),
        self::TYPE_FIELDNAME     => array('id_user', 'nom', 'prenom', 'email', 'mdp', 'tel', 'droit', 'photo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUser' => 0, 'Nom' => 1, 'Prenom' => 2, 'Email' => 3, 'Mdp' => 4, 'Tel' => 5, 'Droit' => 6, 'Photo' => 7, ),
        self::TYPE_CAMELNAME     => array('idUser' => 0, 'nom' => 1, 'prenom' => 2, 'email' => 3, 'mdp' => 4, 'tel' => 5, 'droit' => 6, 'photo' => 7, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID_USER => 0, UserTableMap::COL_NOM => 1, UserTableMap::COL_PRENOM => 2, UserTableMap::COL_EMAIL => 3, UserTableMap::COL_MDP => 4, UserTableMap::COL_TEL => 5, UserTableMap::COL_DROIT => 6, UserTableMap::COL_PHOTO => 7, ),
        self::TYPE_FIELDNAME     => array('id_user' => 0, 'nom' => 1, 'prenom' => 2, 'email' => 3, 'mdp' => 4, 'tel' => 5, 'droit' => 6, 'photo' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    {
        $this->addRelation('Actualite', '\\SilntiBundle\\Model\\Actualite', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_user',
    1 => ':id_user',
  ),
), null, null, 'Actualites', false);
  ...
  array (
    ...
    1 => ':id_user',
        ...
        $this->addRelation('Etudiant', '\\SilntiBundle\\Model\\Etudiant', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':id_user',
    1 => ':id_user',
  ...
  array (
    ...
    1 => ':id_user',
        ...
        $this->addRelation('Page', '\\SilntiBundle\\Model\\Page', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_user',
    1 => ':id_user',
        ...
        $this->addRelation('Prof', '\\SilntiBundle\\Model\\Prof', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':id_user',
    1 => ':id_user',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_MDP);
            $criteria->addSelectColumn(UserTableMap::COL_TEL);
            $criteria->addSelectColumn(UserTableMap::COL_DROIT);
            ...
            $criteria->addSelectColumn($alias . '.droit');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SilntiBundle\Model\User) { // it's a model object
